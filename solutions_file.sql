...
select type,count(*) as total_types from netflix group by type;
...
select type,rating from (
							...
							from netflix
							group by type,rating) as table1 where ranking = 1;
...
select 
	...
	group by new_country order by total_content desc limit 5;
...
-- 10.Find each year and the avg numbers of contrnt release in India on netflix,
